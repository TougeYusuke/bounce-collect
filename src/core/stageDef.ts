...
export const DEFAULT_STAGE_DEF: StageDef = {
  name: 'default',
  /**
   * ⚠️ 段の高さは **255 / 375 / 500**（2026-07-25 れいあ指定・type-01 に揃える）。
   ...
   */
  gates: [
    { x1: 0, x2: W * 0.35, y: 255, multiplier: 3 },
    { x1: W * 0.4, x2: W * 0.6, y: 255, multiplier: 4 },
    { x1: W * 0.65, x2: W, y: 255, multiplier: 3 },
    { x1: 0, x2: W * 0.42, y: 375, multiplier: 4 },
    { x1: W * 0.58, x2: W, y: 375, multiplier: 2 },
    { x1: W * 0.35, x2: W * 0.65, y: 500, multiplier: 4 },
  ],
  /**
   ...
   */
  jumpers: [{ x1: W * 0.06, x2: W * 0.94, y: 545 }],
  dividers: [{ x1: W * 0.5, y1: 311, x2: W * 0.5, y2: 367 }],
};
